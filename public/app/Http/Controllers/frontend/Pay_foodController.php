...
class Pay_foodController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            $paidDonorIds = Payment::whereMonth('payment_date', Carbon::now()->month)
        ...
        try {
            foreach ($request->months as $month) {
                ...
                $existingPayment = Payment::where('donor_id', $request->donor_id)
                    ->whereMonth('payment_date', Carbon::parse($request->payment_date)->month)
                    ->whereYear('payment_date', Carbon::parse($request->payment_date)->year)
                    ->first();
